...
namespace GetSingleProduct
{
    public class Startup
    {
        ...
        {
            services.AddScoped<MagentoService, MagentoService>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "GetSingleProduct", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "GetSingleProduct v1"));
            }
